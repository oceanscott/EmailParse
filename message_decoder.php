 ...
 * message_decoder.php
 *
 * @(#) $Header: /opt2/ena/metal/mimeparser/message_decoder.php,v 1.13 2012/04/11 09:28:19 mlemos Exp $
 *
 */
...
{		
	 ...
	 */
		...
		else
		{
			...
			$this->parsingMultiDimensionArray($decoded);
			//$this->ShowEmailInfo($decoded, $results);
			//echo "<br>";
		...
		if((count($decoded['0']) > 0) && (array_keys($decoded['0']) != ""))
		{
			...
			{ 		
				...
				(@array_keys($decoded['0'][$FirstDimensionalArray[$first]]) != "")) // 如果還有下一層就繼續尋找
				{
					...
					{ 
							...
							(@array_keys($decoded['0'][$FirstDimensionalArray[$first]][$SecondDimensionalArray[$second]]) != ""))
						{
							...
							{
									$this->SaveAttachment($decoded['0'][$FirstDimensionalArray[$first]][$SecondDimensionalArray[$second]]);
							}
							else
							{
								...
								for ($third=0; $third < count($decoded['0'][$FirstDimensionalArray[$first]][$SecondDimensionalArray[$second]]); $third++) 
								{
										...
										(@array_keys($decoded['0'][$FirstDimensionalArray[$first]][$SecondDimensionalArray[$second]][$ThirdDimensionalArray[$third]]) != ""))
									{
										...
										*/
										...
										{
											if((count($decoded['0'][$FirstDimensionalArray[$first]][$SecondDimensionalArray[$second]][$ThirdDimensionalArray[$third]][$FourthDimensionalArray[$fourth]]) > 0) && 
												(@array_keys($decoded['0'][$FirstDimensionalArray[$first]][$SecondDimensionalArray[$second]][$ThirdDimensionalArray[$third]][$FourthDimensionalArray[$fourth]]) != ""))
											{
												$FifthDimensionalArray = array_keys($decoded['0'][$FirstDimensionalArray[$first]][$SecondDimensionalArray[$second]][$ThirdDimensionalArray[$third]][$FourthDimensionalArray[$fourth]]);
												//var_dump($FifthDimensionalArray);
												for ($fifth=0; $fifth < count($decoded['0'][$FirstDimensionalArray[$first]][$SecondDimensionalArray[$second]][$ThirdDimensionalArray[$third]][$FourthDimensionalArray[$fourth]]); $fifth++) 
												{
													
													if(isset($decoded['0'][$FirstDimensionalArray[$first]][$SecondDimensionalArray[$second]][$ThirdDimensionalArray[$third]][$FourthDimensionalArray[$fourth]][$FifthDimensionalArray[$fifth]]) &&
													 ([$FifthDimensionalArray[$fifth]] != ""))
													{
														$tmp = $decoded['0'][$FirstDimensionalArray[$first]][$SecondDimensionalArray[$second]][$ThirdDimensionalArray[$third]][$FourthDimensionalArray[$fourth]][$FifthDimensionalArray[$fifth]];
														$this->SaveParsingResult($FifthDimensionalArray[$fifth],$tmp);
													}
												}
											}
											else
											{
												...
												{
													$tmp = $decoded['0'][$FirstDimensionalArray[$first]][$SecondDimensionalArray[$second]][$ThirdDimensionalArray[$third]][$FourthDimensionalArray[$fourth]];
													
													$this->SaveParsingResult($FourthDimensionalArray[$fourth],$tmp);//,$decoded['0'][$FirstDimensionalArray[$first]][$SecondDimensionalArray[$second]][$ThirdDimensionalArray[$third]][$FourthDimensionalArray[$fourth]]);
												}
											}
									...
									else
									{
										...
										{
											$tmp = $decoded['0'][$FirstDimensionalArray[$first]][$SecondDimensionalArray[$second]][$ThirdDimensionalArray[$third]];
											$this->SaveParsingResult($ThirdDimensionalArray[$third],$tmp);//,$decoded['0'][$FirstDimensionalArray[$first]][$SecondDimensionalArray[$second]][$ThirdDimensionalArray[$third]]);
										}
									}
								}//for ($third=0; $third < count($decoded['0'][$FirstDimensionalArray[$first]][$SecondDimensionalArray[$second]]; $third++)
							}
						...
						else
						{
							...
							{
								$tmp = $decoded['0'][$FirstDimensionalArray[$first]][$SecondDimensionalArray[$second]];
								$this->SaveParsingResult($SecondDimensionalArray[$second],$tmp);//,$decoded['0'][$FirstDimensionalArray[$first]][$SecondDimensionalArray[$second]]);
							}
						}
					}//for ($second=0; $second < count($decoded['0'][$FirstDimensionalArray[$first]]; $second++) 
				...
				else //if(count($decoded['0'][$FirstDimensionalArray[$first]]) > 0) // 如果還有下一層就繼續尋找
				{
					...
					{
						$tmp = $decoded['0'][$FirstDimensionalArray[$first]];
						$this->SaveParsingResult($FirstDimensionalArray[$first],$tmp);//$decoded['0'][$FirstDimensionalArray[$first]]);
					}
				}
			}//for ($first=0; $first < count($decoded['0']); $first++)
	...
	function SaveParsingResult($ParsingIndex, $ParsingResult)
	{
		...
		if(!is_array($ParsingResult) && ($ParsingResult != "") && ($ParsingIndex != '0'))
		{
			//echo "<br>Index:".$ParsingIndex;
			switch ($ParsingIndex) {
				case "Body":
					$EmailInfo['Body'][] = $ParsingResult;
					//echo "<br>----Body ParsingResult : ".$ParsingResult."Index:".$ParsingIndex;
					//echo mb_detect_encoding($ParsingResult);
					break;
				case 'from':
				case 'from:':
					$EmailInfo['from'][] = $ParsingResult;
					//echo "<br>----from ParsingResult : ".$ParsingResult;
					break;
				case 'to':
				case 'to:':
					$EmailInfo['to'][] = $ParsingResult;
					//echo "<br>----to ParsingResult : ".$ParsingResult;
					break;
				case 'subject':
				case 'subject:':
				case 'Subject':
				...
				case 'value':
				case 'value:':
				//echo "<br>".mb_detect_encoding($ParsingResult);
				//$ParsingResult = mb_convert_encoding("UTF-8", "BIG5",$ParsingResult);
				//$ParsingResult = iconv('GBK', 'UTF-8', $ParsingResult);
				//$ParsingResult = iconv('BIG5',	'UTF-8', $ParsingResult);
				
				//echo "<br>----subject ParsingResult : ".$ParsingResult;
				//$ParsingResult = utf8_encode($ParsingResult);

				//echo mb_substr($ParsingResult,0,10,'utf8');
				//$ParsingResult = iconv(mb_detect_encoding($ParsingResult), 'UTF-8//IGNORE', $ParsingResult);
				//$ParsingResult_new = iconv(mb_detect_encoding($ParsingResult), "UTF-8", $ParsingResult);
				//$ParsingResult = iconv(mb_detect_encoding($ParsingResult_new), "UTF-8", $ParsingResult);
				//$ParsingResult = chr($ParsingResult);
				...
				case 'date:':
					...
					//echo "<br>----date ParsingResult : ".$ParsingResult;
					break;
				default:
					break;
	...
	function SaveAttachment($ParsingAttachmentResult)
	{
		if(($ParsingAttachmentResult["FileName"] != "") && ($ParsingAttachmentResult["BodyLength"] > 0))
		{
			$file = fopen($ParsingAttachmentResult["FileName"],"w");
 		   	echo "<br>";
			fwrite($file,$ParsingAttachmentResult["Body"]);
			fclose($file);
		}
		//var_dump($decoded['0']);
	}
